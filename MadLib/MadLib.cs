    ...
    class MadLib
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"{prompt} Noun.\n" +
                ...
                $"or things ( common noun ), or to name a particular one of these ( proper noun ). This should also be present tense (i.e swim, run." );
            ...
            Console.Clear();
            Console.WriteLine($"One day there was a {verb} that didn't want to run anymore. And so, like any good {adjective} the {noun}\n" +
                $"decided to go {verb2}. But sometimes the universe a {adjective2} mistress, and destiny {adverb} called. After that,\n" +
                $"the {verb} exclaimed {exclaimation}, and they heard it all the way in {cityName}! And the {verb} vowed not to return until\n" +
                $"{timeOfDay}.");
